#### simulate policy gradient block for participant ----
sim.block = function(subject,parameters,cfg){ 
  ...
  for (block in 1:Nblocks){
    ...
    for (trial in 1:Ntrials){
      ...
      Qval[choice]   = Qval[choice] + alpha_ch*PE*beta*(1-p[choice])
      Qval[unchosen] = Qval[unchosen] + alpha_unch*(-PE)*beta*p[choice]
