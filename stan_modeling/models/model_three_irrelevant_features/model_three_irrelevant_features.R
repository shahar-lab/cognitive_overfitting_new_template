...
sim.block = function(subject,parameters,cfg){ 
  ...
  beta_texture = parameters['beta_texture']
  #set initial var
  Narms              = cfg$Narms
  ...
  for (block in 1:Nblocks){
    ...
    for (trial in 1:Ntrials_perblock){
      ...
      Qnet[1] = beta_key*Q_keys_offered[1]+beta_color*Q_colors[colors[1]] +beta_shape*Q_shapes[shapes[1]]+beta_texture*Q_textures[textures[1]]
      Qnet[2] = beta_key*Q_keys_offered[2]+ beta_color*Q_colors[colors[2]]+beta_shape*Q_shapes[shapes[2]]+beta_texture*Q_textures[textures[2]]
