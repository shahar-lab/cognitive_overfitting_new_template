...
for (subject in 1:Nsubjects) {
  ...
  if (first_trial_in_block[subject,trial] == 1) {
      ...
      Q_keys=Q_keys_initial;
          ...
          Qnet[1]=Q_cards[card_left[subject,trial]]+omega[subject]*Q_keys[1]; //We compound the value of the card appearing on the left and the value of the left key.

          Qnet[2]=Q_cards[card_right[subject,trial]]+omega[subject]*Q_keys[2];
