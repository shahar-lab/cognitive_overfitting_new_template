...
for (subject in 1:Nsubjects) {
  ...
  lambda0[subject]   = (population_locations[3]           + population_scales[3] * lambda0_random_effect[subject]);  
  lambda1[subject]   = (population_locations[4]           + population_scales[4] * lambda1_random_effect[subject]);  
...
//updating weights
lambda= lambda0[subject]+lambda1[subject] * (PE_task[subject, trial]);
